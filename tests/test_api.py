...
def test_tool_router_lists_tools(client: TestClient) -> None:
    ...
    assert response.json() == {"tools": [
        ...
        "developer.create_branch", "developer.create_issue", "developer.create_pull_request", "developer.get_issue", "developer.get_pull_request",
        "developer.get_pull_request_diff", "developer.get_repository", "developer.list_branches", "developer.list_commits", "developer.list_issues",
        "developer.list_pull_request_files", "developer.list_pull_requests", "developer.read_file", "developer.update_file",
